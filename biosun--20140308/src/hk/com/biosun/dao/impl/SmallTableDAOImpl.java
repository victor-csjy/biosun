/*
 * 说明：对应数据库表small_table的DAOImpl类<br>
...
public class SmallTableDAOImpl implements SmallTableDAO {
	 ...
	 *
	 * @param sql  关于small_table表的SQL语句
