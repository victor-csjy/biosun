/*
 * 说明：对应数据库表supply_table的DAOImpl类<br>
...
public class SupplyTableDAOImpl implements SupplyTableDAO {
	 ...
	 * @param supplyId
	 *
	 * @return SupplyTable对象,可能为null对象
	 */
	 ...
	 *
	 * @param sql  关于supply_table表的SQL语句
