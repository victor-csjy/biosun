...
<%
	...
	if (Action != null && Action.equals("change_set")
			&& !content.equals("")) {
		int result = newsTableService.add(news_title, news_type,
				news_date, is_show, is_roll, order_id, content);
		if (result > 0) {
			out
...
-->
	...
	<body>
		<div align="center">
			<br>
			<form name="form1" method="POST" action="news_add.jsp"
								...
								<tr>
									...
									<td valign="top">
										<input name="news_date" type="text" id="news_date"
											value="<%=DateUtil.formatDate(System.currentTimeMillis(), 2)%>"
								...
								<tr>
									...
									<td valign="top">
										<label>
											...
											是 &nbsp;&nbsp;
											<input name="is_roll" type="radio" value="0" checked>
											否
										</label>
									</td>
								</tr>
