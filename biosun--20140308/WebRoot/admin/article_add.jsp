...
if(Action!=null&&Action.equals("change_set")&&!content.equals("")){
  int result=articleService.add(title,content,article_type,article_date,is_show,order_id);
  if(result>0){  
...
<div align="center">
<br><br>
<form name="form1" method="POST" action="article_add.jsp"  onSubmit="return on_submit()" >
  <table width="811" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="628" valign="top"  ><input name="title" type="text" id="title" size="60" maxlength="150" ></td>
	       </tr>
	       <tr >
	...
	<select name="article_type" id="article_type">
        <option value="about_us" <%if(article_type.equals("about_us"))out.print("selected");%>>About Us</option>
    <option value="sale_and_market" <%if(article_type.equals("sale_and_market"))out.print("selected");%>>Sale and Market</option>
        <option value="service" <%if(article_type.equals("service"))out.print("selected");%>>Service</option>
		 <option value="careers" <%if(article_type.equals("careers"))out.print("selected");%>>Careers</option>
		  <option value="contact" <%if(article_type.equals("contact"))out.print("selected");%>>Contact</option>
        </select></td>
            </tr><tr >
	         <td height="26" valign="middle"  >&nbsp;	 发布日期： </td>
    <td valign="top"  ><input name="article_date" type="text" id="article_date" 
	  value="<%=DateUtil.formatDate(System.currentTimeMillis(),2)%>" size="25" maxlength="150" ></td>
             </tr>
	<tr >
...
否
    ...
    <td valign="top"  ><input name="order_id" type="text" id="order_id" value="0"  size="10" maxlength="150" ></td>
             </tr>
	 ...
	 <td height="26" colspan="2" valign="middle"  >&nbsp;	 文章内容： </td>
	        ...
	        <tr class="chinese">
	          <td height="26" colspan="2" align="center" valign="middle"><p align="center">
                                  <input name="B2" type="submit" class="button" id="B2" value="确定">
